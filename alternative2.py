...
first such target part. Which part is used is given by the script's single
argument: 'plain', 'html', 'calendar', 'related', or 'mixed'.
...
parser = argparse.ArgumentParser(
    description="Replace a 'multipart/alternative' part by one of its target parts."
)
parser.add_argument(
    "target", choices=TARGETS.keys(), help="which alternative part to keep"
)
